...
const LvBadge = ({ level }) => { const c = { misafir: ['☕', 'Fiore Misafir', COLORS.gray, 'rgba(107,114,128,0.1)'], mudavim: ['⭐', 'Fiore Müdavim', COLORS.fioreOrange, COLORS.orangeGlow], goat: ['🐐', 'Fiore GOAT', COLORS.gold, COLORS.goldBg] }[level]; return <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: c[3], padding: '5px 12px', borderRadius: 20, fontSize: 12, color: c[2], fontWeight: 800, border: `1.5px solid ${c[2]}30` }}>{c[0]} {c[1]}</div>; };
